<template>
  <div class="w-11/12 mb-2 flex flex-row justify-between items-center light-text">
    <a href="#" class="lg:mb-0 ml-7 md:ml-0 text-xl lg:text-2xl font-bold text-left md:text-center lg:text-left">
    ...
    <div class="flex justify-between items-center relative" @mouseleave="hideSignOutLabel">
      ...
      <div id="userImage" class="w-9 h-9 mx-2 rounded-3xl border border-white cursor-pointer overflow-hidden" @mouseenter="showSignOutLabel">
        <img src="@/assets/default-profile.png" alt="profile picture" class="w-full">
      </div>
      <div id="signOutBtn" class="absolute hidden right-0 rtl:right-auto rtl:left-0 top-full py-2 px-3 rounded-3xl bg-gray-500 bg-opacity-70 light-text">
